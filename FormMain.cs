...
namespace GIF_Viewer
{
    ...
    public partial class FormMain : Form
    {
        ...
        private void tlc_timeline_RangeChanged(object sender, RangeChangedEventArgs eventArgs)
        {

        }

        private void lblFrame_Click(object sender, EventArgs e)
        {

        }

        private void pb_gif_Click(object sender, EventArgs e)
        {
